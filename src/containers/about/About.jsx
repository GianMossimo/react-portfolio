  ...
  return (
    <div className='port__about-container' id='about'>
      <div className='port__about-container-text'>
        ...
        <br />
        <Bio text="Outside of an active lifestyle, I love to watch movies and shows. My favorite types of movies/media are Sci-Fi, and the Dune movies have taken their place as my favorites (and now I am going to venture into the books because of it). I love playing video games, and my current fixation is Helldivers 2." />
        <br />
